...
const CreateQuestion = () => {
  ...
  const handleSubmit = async () => {
    setLoading(true);
    try {
      if (type === "descriptive" && !form.descriptive.sampleAnswer.trim()) {
        toast.error("Sample answer is required for descriptive questions");
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <Card className="p-8 space-y-6 bg-slate-900 border-slate-800">
        <h1 className="text-2xl font-black text-white">Create New Question</h1>
        ...
        {type === "descriptive" && (
          <Textarea
            label="Sample Answer (Required for AI Evaluation)"
        ...
        {type === "coding" && (
          <div className="space-y-6">
            ...
            {/* Hidden Test Cases */}
            <div>
              <h4 className="font-bold text-white mb-2">Hidden Test Cases</h4>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 mt-1">
                  Hold <kbd>Ctrl</kbd> (Windows) or <kbd>Cmd</kbd> (Mac) to
                  select multiple
                </p>
              </div>
            </div>
